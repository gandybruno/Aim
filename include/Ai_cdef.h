/******************************************************************************
           ...
           Copyright (c) AIM GmbH 2001-2015, 79111 Freiburg, Germany.
...
#if !defined(_AIM_WINDOWS) && !defined(_AIM_VMEWINDOWS) && !defined(_AIM_VME) && !defined(_AIM_VXI) && !defined(_AIM_LINUX) && !defined(_AIM_QNX) && !defined(_AIM_TARGET_SW) && !defined(_AIM_SYSDRV)
    #error target macro not defined !! _AIM_WINDOWS or _AIM_VMEWINDOWS or _AIM_VME or _AIM_VXI or _AIM_LINUX or _AIM_QNX or _AIM_TARGET_SW or _AIM_SYSDRV
/*
...
or
define _AIM_LINUX for using the 32-Bit Linux libraryin application !!!
*/
#endif
...
#include "Ai_exports.h"
  ...
  /***************************************/
    ...
    #if defined(_AIM_WINDOWS) || defined(_AIM_VXI) || defined(_AIM_VMEWINDOWS) /* 32-Bit Windows */
      #define _API_DLL_FUNC __stdcall
      #define _API_ISR_FUNC __stdcall
      #ifdef __cplusplus
...
#if defined(_AIM_WINDOWS) || defined(_AIM_VMEWINDOWS) || defined(_AIM_QNX) || defined(_AIM_SYSDRV)
...
/******************************************/
#if !defined(_AIM_VMEWINDOWS) && (defined(_AIM_VME)) || (defined(_AIM_LINUX) && (!defined(OS_TARGET))) || defined(_AIM_QNX)
#ifndef BYTE_DEFINED
